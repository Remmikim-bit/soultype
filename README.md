...
대화 한 번 올리면 여러 번 분석할 수 있어요. 원문은 서버로 보내지 않아요.

## 목록

1. **AI 자아 스캔** — 지금까지 시킨 말로, AI가 어떤 성격인지 알아봐요
2. **학대 지수** — 반말부터 차근차근 세어 볼게요
3. **AI 궁합 테스트** — 나랑 AI, 연애로 보면 몇 점인지 알아봐요
4. **AI 조련 만렙** — 초보부터 파트너까지, 지금은 몇 렙인지 알아봐요
5. **AI 티키타카 배틀** — 90초 동안 누가 더 잘 시키는지 겨뤄 봐요
6. **AI 텐션 라이브** — 요즘 다들 무슨 말을 걸고 있는지 보여 드릴게요

문장 하나를 넣거나, Grok / ChatGPT / Claude 대화 JSON을 이 기기에 올리면 돼요. 광고를 보면 결과가 열려요.

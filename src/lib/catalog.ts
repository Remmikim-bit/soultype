...
export const TESTS: TestMeta[] = [
  ...
  },
  {
    ...
    no: "02",
    name: "AI의 스트레스 지수",
    hook: "내 AI는 스트레스를 받고 있을지 알아봐요.",
    need: "session",
    theater: ["반말부터 세고 있어요", "부탁은 몇 번인지 세어 보고 있어요", "거친 말투를 분석하고 있어요"],
    teaser: "분석이 끝났어요. 이제 숫자를 열어볼 수 있어요.",
  },
  {
    id: "love",
    no: "03",
    name: "AI 궁합 테스트",
    hook: "나랑 AI는 얼마나 손발이 맞을까요?",
    need: "session",
  ...
  },
  {
    ...
    need: "session",
    theater: ["문장 길이를 재고 있어요", "조건을 찾고 있어요", "얼마나 잘 시키는지 보고 있어요"],
  ...
  },
  {
    ...
    need: "none",
    theater: ["동일한 과제를 어떻게 해결하는지 분석하고 있어요", "프롬프트만 읽고 있어요", "점수를 매기고 있어요"],
  ...
  },
  {
    ...
    no: "06",
    name: "AI 텐션 라이브",
    hook: "다른 사람들은 요즘 AI와 어떤 대화를 나누는지 보여 드릴게요.",
    need: "none",

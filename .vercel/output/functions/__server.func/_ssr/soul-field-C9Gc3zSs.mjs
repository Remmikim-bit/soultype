...
//#region node_modules/.nitro/vite/services/ssr/assets/soul-field-C9Gc3zSs.js
...
function SoulField({ stage, axes, locked, quadrant, caption }) {
	...
	(0, import_react.useEffect)(() => {
		...
		const tick = (now) => {
			...
			const want = p.stage === "gate" ? .62 : p.stage === "result" ? .54 : .5;
			...
			uniforms.uScale.value = params.size * lay.scale * (1 + .028 * Math.sin(t * .37));
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "soul-frost" }),

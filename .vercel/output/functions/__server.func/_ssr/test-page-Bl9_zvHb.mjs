...
import { a as TEST_IDS, c as parseExport, d as useAppStore, i as TESTS, l as relatedOf, n as ArrowGlyph, o as TEST_PATH, r as SiteShell, s as cn, t as AdSlot, u as testOf } from "./ad-slot-799EHAba.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/test-page-Bl9_zvHb.js
...
function RelatedTests({ current }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			...
			children: "이런 분석도 있어요"
		}), items.map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
			href: TEST_PATH[t.id],
			className: "cta-row",
...
function ContinueStrip({ current }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [next && next.id !== current ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
			href: TEST_PATH[next.id],
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					card.shallow ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: "문장이 짧아요. 파일을 올리면 더 또렷해져요."
					}) : null
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {

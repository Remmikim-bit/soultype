...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CnsJnKbf.mjs");
...
var manifest = { "74162b8540f4d23bb11989c8205a4ace5e185bea902ddd393832c55bd8596975": {
	functionName: "analyzeUsage_createServerFn_handler",
	importer: () => import("./analyze-CEfc5Oiz.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-kirSlODT.mjs").then((n) => n.t),
